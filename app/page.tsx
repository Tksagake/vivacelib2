          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/benefits" className="text-gray-300 hover:text-purple-300 transition-colors">Benefits</a></li>
                <li><a href="/about" className="text-gray-300 hover:text-purple-300 transition-colors">About Us</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-300">info@vivacemusic.com</span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
